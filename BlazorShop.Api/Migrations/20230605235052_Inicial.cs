    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Luis Rachope" });

            migrationBuilder.InsertData(
                table: "Produtos",
                columns: new[] { "Id", "CategoriaId", "Descricao", "ImagemUrl", "Nome", "Preco", "Quantidade" },
                values: new object[] { 1, 1, "Um kit fornecido pela Natura, contendo produtos para cuidados com a pele.", "/Imagens/Beleza/Beleza1.png", "Glossier - Beleza Kit", 100m, 100 });
